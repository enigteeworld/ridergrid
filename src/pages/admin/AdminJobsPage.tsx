    ...
    <div className="space-y-6 pb-6">
      ...
      {isLoading ? (
        ...
        <Card className="border-dashed border-2">
          <CardContent className="p-8 text-center text-gray-500">No jobs found</CardContent>
        </Card>
      ) : (
        <div className="space-y-3">
          ...
          {selectedJob && (
            <div className="space-y-5">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <span className="font-semibold text-lg text-gray-900 break-words">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <p className="font-medium text-gray-900 break-words">
                    {selectedJob.rider_name || 'Not assigned'}
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <p className="font-medium text-gray-900">
                    {formatCurrency(selectedJob.agreed_amount)}
                  </p>
                </div>
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <p className="font-medium text-gray-900">
                    {formatCurrency(selectedJob.platform_fee)}
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-lg border p-4">
                  ...
                  <p className="text-sm text-gray-500 mt-2 break-words">
                    {selectedJob.pickup_contact_name || 'No contact'} •{' '}
                    {selectedJob.pickup_contact_phone || 'No phone'}
                  </p>
                </div>
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <p className="font-medium text-gray-900 break-words">
                    {selectedJob.delivery_address}
                  </p>
                  <p className="text-sm text-gray-500 mt-2 break-words">
                    {selectedJob.delivery_contact_name || 'No contact'} •{' '}
                    {selectedJob.delivery_contact_phone || 'No phone'}
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg border p-4">
                ...
                <p className="text-gray-900 break-words">
                  {selectedJob.package_description || 'No description'}
                </p>
              </div>
            </div>
          )}
